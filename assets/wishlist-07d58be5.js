import"./main-eb99f88c.js";const h="https://ec-course-api.hexschool.io/v2/api/hex-project/products/all",c=document.querySelector(".product-wrap2"),v=document.querySelector(".product-select"),b=document.querySelector(".pagination");let u=[];function x(){axios.get(`${h}`).then(function(t){u=t.data.products,p(),y()}).catch(function(t){console.log(t)})}x();function f(t){const n=o(t.id)?"bi-heart-fill":"bi-heart";return`
